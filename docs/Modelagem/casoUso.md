...
O diagrama de casos de uso do fluxo de Críticas e Filmes pode ser acessado por este [link](../assets/casosDeUso/criticasFilmes.pdf). A especificação de cada caso de uso pode ser observador a seguir.
...
<figure markdown>
  ![Caso de uso 11](../assets/casosDeUso/l1uc11.png)
...
<figure markdown>
  ![Caso de uso 12](../assets/casosDeUso/l1uc12.png)
...
<figure markdown>
  ![Caso de uso 13](../assets/casosDeUso/l1uc13.png)
