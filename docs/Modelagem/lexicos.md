...
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Watched | Assistido | Registrar Visualização | Indica a ação de registrar que um usuário assistiu a um filme específico | Os usuários podem marcar os filmes como assistidos para acompanhar seu histórico de visualizações e compartilhar essa informação com a comunidade do Letterboxd | Estado |

### Léxico 6: Comment 
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Comment | Comentário | Feedback | Refere-se a um texto escrito respondendo a algo | Os usuários podem comentar nas reviews de outros usuários | Ação |
...
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Followers | Seguidores | Amigos | Refere-se aos usuários que escolheram acompanhar as atividades de um determinado perfil no Letterboxd | Os usuários podem ter seguidores que recebem atualizações de suas avaliações, listas e atividades, permitindo uma interação mais ampla na comunidade do Letterbox | Estado |

### Léxico 9: Notifications
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Notifications | Notificações | Alertas, Mensagens | Refere-se às informações e avisos enviados aos usuários para informar sobre atividades relevantes, como novos comentários, avaliações de filmes ou seguidore | Os usuários recebem notificações em tempo real, permitindo que fiquem atualizados sobre as interações e atividades recentes dentro da comunidade do Letterbox | Objeto |

### Léxico 10: Search
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Search | Explorar | Descobrir, Pesquisar | efere-se à ação de procurar e encontrar filmes novos e interessantes dentro do aplicativ | Os usuários podem explorar diferentes categorias, gêneros, listas populares e recomendações personalizadas para descobrir filmes que possam despertar seu interess | Ação |

### Léxico 11: Tag
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Tag | Etiqueta | Marcador | Representa uma palavra-chave ou termo associado a um filme, utilizado para categorização e facilitar a busc | Os usuários podem adicionar tags aos filmes para organizá-los e para facilitar a identificação de filmes com temas ou elementos específico | Objeto |

### Léxico 12: Like
| Léxico | Tradução | Sinônimo | Noção | Impacto | Classificação |
| ---- | ------ | ------ | --------- | ----- | ------- |
| Like | Curtir | Adicionar aos Favoritos | ndica a ação de destacar um filme como favorito ou preferido pelo usuári | Os usuários podem marcar filmes como favoritos para sinalizar suas obras preferidas, facilitando o acesso rápido a esses filmes e compartilhando suas preferências com outros usuário | Ação |
