...
| IT06 | A plataforma deve permitir que o usuário pesquise e encontre listas, resenhas, atores, estúdios, outros membros, artigos de jornal e podcas | Alta prioridade | Funcionalidade já implementada, portanto é tida como Alta Prioridade |
...
| IT13 | O usuário deve ser capaz de ver suas listas, curtidas, likes, filmes assistidos, seguidores e pessoas que seguem | Alta prioridade | Funcionalidade já implementada, portanto é tida como Alta Prioridade |
...
| IT20 | O usuário deve ser capaz de realizar algumas atividades sem ter um cadastro, como ver filmes e suas estatísticas, listas, notícias e resenhas | Funcionalidade já implementada, portanto é tida como Alta Prioridade |
